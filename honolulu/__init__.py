...
from .events import HonoluluEventScraper


class Honolulu(Jurisdiction):
    division_id = "ocd-division/country:us/state:hi/place:honolulu"
    classification = "government"
    name = "City of Honolulu"
    url = "http://www.honolulu.gov/"
    scrapers = {
        "events": HonoluluEventScraper,
    }
