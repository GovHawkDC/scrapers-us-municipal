...
from .events import DesmoinesEventScraper


class Desmoines(Jurisdiction):
    division_id = "ocd-division/country:us/state:ia/place:des_moines"
    classification = "government"
    name = "City of Des Moines"
    url = "http://dsm.city"
    scrapers = {
        "events": DesmoinesEventScraper,
    }
